...
- [x] Make high-latitude, polar, shafaq and angle settings explicit; store raw prayer instants; version the cache; and verify DST-safe timezone formatting across cache, snapshots and Home.
